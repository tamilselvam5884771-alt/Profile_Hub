        ...
        <main className="flex-1 overflow-y-auto p-6 space-y-6 custom-scrollbar">
          ...
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
            ...
            <div className="space-y-6 lg:col-span-2">
              ...
              <div className="flex h-64 items-center justify-center rounded-2xl border border-[#083030]/60 bg-[#011414]/50 p-6 text-[#7da3a3] shadow-lg shadow-black/20">
            ...
            <div className="space-y-6">
              ...
              <div className="flex h-48 items-center justify-center rounded-2xl border border-[#083030]/60 bg-[#011414]/50 p-6 text-[#7da3a3] shadow-lg shadow-black/20">
                <span className="font-semibold tracking-wide">QuickActions Placeholder</span>
              </div>

              {/* RecentActivity Placeholder */}
              <div className="flex h-80 items-center justify-center rounded-2xl border border-[#083030]/60 bg-[#011414]/50 p-6 text-[#7da3a3] shadow-lg shadow-black/20">
